...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      // Ativado: verde #10B981
      "peer inline-flex h-7 w-14 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#10B981] focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-[#10B981] data-[state=unchecked]:bg-input",
      className
    )}
    {...props}
    ref={ref}
